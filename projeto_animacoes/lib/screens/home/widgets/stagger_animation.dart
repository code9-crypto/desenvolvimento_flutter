...
import 'package:projeto_animacoes/screens/home/widgets/fade_container.dart';
              ...
              return Stack(
                children: [
                  ListView(
                    ...
                    //tirando todo afastamento que vem por padrão na listaView
                    children: [
                      HomeTop(
                  ...
                  //Esta classe está fazendo a animação de transição
                  IgnorePointer(
                    child: FadeContainer(
