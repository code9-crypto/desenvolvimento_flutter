...
class DriveService {
  final String _credentialsPath = 'lib/assets/credentials_loja_pai.json';
  final String parentFolderId = '1Sh2Nb63uktigsdZL5h_GukstuMDZqvKW';
  ...
  Future<drive.DriveApi> connect() async {
    try {
      ...
      if (kDebugMode) {
        print('Erro em conectar ao google Drive: $e');
      }
      rethrow;
    }
  }
