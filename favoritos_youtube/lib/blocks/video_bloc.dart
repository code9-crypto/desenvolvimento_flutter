...
class VideoBlock extends BlocBase{
  ...
  //funções get do searchController e do videoController
  ...
  //Esta função será chamada toda vez que quando houver uma pesquisa pelos videos
  void _search(String search) async {
    ...
    _videosController.sink.add(videos); //depois que a pesquisa for feita, a lista será adicionada ao videosController
  }
